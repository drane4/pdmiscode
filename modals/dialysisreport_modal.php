                                                    ...
                                                    <div class="row clearfix">
                                                       <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-3 col-xs-offset-3">
                                                           ...
                                                           <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail2" style="width:81%; color:black">Patient Weight Summary</button> <br>
                                                            <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="schedule" style="width:81%; color:black">Patient Schedule Status</button><br>
                                                            ...
                                                            <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail5" style="width:70%; color:black">ESRD Causes</button>&nbsp;<button class="btn bg-grey m-t-15 waves-effect" name="esrdstat"> <i class="material-icons">trending_up</i></button><br>

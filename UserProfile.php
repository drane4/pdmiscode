    ...
    <body class="theme-indigo">
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                        ...
                        <li id="maintenance" class="active">
                            ...
                            <ul class="ml-menu">
                                <li id="userprofile" class="active">
                                    <a href="UserProfile.php">User Accounts</a>
                                </li>
                ...
                <div class="legal">
                    <div class="copyright">
                        &copy; 2018 <a href="javascript:void(0);">Dynamic Explorers</a>.
                    </div>
                                  ...
                                  <div class="row clearfix ">
                                        <div class="col-lg-12 col-md-12 col-sm-13 col-xs-12">
                                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">   
                                            ...
                                            <label for="transaction_a">HemoTreatment</label>
                                                   </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            ...
                                            <label for="userprofile_a">User Accounts</label>                                         
                                                </div>
                                              <div class="form-group input-group">                                  
